...
function Home() {
  return (
    <>
      <main className="bg-sky-img bg-no-repeat bg-cover min-h-[calc(100vh-101px)] opacity-95 flex justify-center items-center content-center gap-10 flex-wrap p-7 ">
